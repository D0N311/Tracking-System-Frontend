      ...
      >
        ...
        <div className="space-y-8">
          ...
          <div className=''>
            ...
            <ul className="mt-3">
              {/* dashboard */}
              <SidebarLinkGroup activecondition={pathname === '/dashboard/admin'}>
                    {(handleClick, open) => {
                      return (
                        <React.Fragment>
                          <Link
                            ...
                            className={`block text-slate-200 truncate transition duration-150 ${
                              pathname === '/dashboard/admin' ? 'hover:text-slate-200' : 'hover:text-white'
                            }`}
                            onClick={(e) => {
                              e.stopPropagation();
                          ...
                          <svg className="w-6 h-6 shrink-0" viewBox="0 0 24 24">
                            <path
                              className={`fill-current ${
                                pathname === '/dashboard/admin' ? 'text-indigo-500' : 'text-slate-400'
                              }`}
                              d="M12 0C5.383 0 0 5.383 0 12s5.383 12 12 12 12-5.383 12-12S18.617 0 12 0z"
                            />
                            <path
                              className={`fill-current ${
                                pathname === '/dashboard/admin' ? 'text-indigo-600' : 'text-slate-600'
                              }`}
                              d="M12 3c-4.963 0-9 4.037-9 9s4.037 9 9 9 9-4.037 9-9-4.037-9-9-9z"
                            />
                            <path
                              className={`fill-current ${
                                pathname === '/dashboard/admin' ? 'text-indigo-200' : 'text-slate-400'
                              }`}
              ...
              {/* Company */}
              <SidebarLinkGroup activecondition={pathname.includes('/dashboard/admin/company')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                      <Link
                        ...
                        className={`block text-slate-200 truncate transition duration-150 ${
                            pathname.includes('/dashboard/admin/company') ? 'hover:text-slate-200' : 'hover:text-white'
                        }`}
                        onClick={(e) => {
                            sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                        }}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="w-6 h-6 shrink-0" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${pathname.includes('/dashboard/admin/company') ? 'text-indigo-300' : 'text-slate-400'}`}
                                d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
                              />
                              <path
                                className={`fill-current ${pathname.includes('/dashboard/admin/company') ? 'text-indigo-600' : 'text-slate-700'}`}
                                d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"
                              />
                              <path
                                className={`fill-current ${pathname.includes('/dashboard/admin/company') ? 'text-indigo-500' : 'text-slate-600'}`}
              ...
              {/* Admin */}
              <SidebarLinkGroup activecondition={pathname.includes('/dashboard/admin/users')}>
                {(handleClick, open) => {
                  return (
                    <React.Fragment>
                       <Link
                        ...
                        className={`block text-slate-200 truncate transition duration-150 ${
                            pathname.includes('/dashboard/admin/users') ? 'hover:text-slate-200' : 'hover:text-white'
                        }`}
                        onClick={(e) => {
                            sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                        }}
                      >
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="w-6 h-6 shrink-0" viewBox="0 0 24 24">
                              <path
                                className={`fill-current ${pathname.includes('/dashboard/admin/users') ? 'text-indigo-500' : 'text-slate-600'}`}
                                d="M18.974 8H22a2 2 0 012 2v6h-2v5a1 1 0 01-1 1h-2a1 1 0 01-1-1v-5h-2v-6a2 2 0 012-2h.974zM20 7a2 2 0 11-.001-3.999A2 2 0 0120 7zM2.974 8H6a2 2 0 012 2v6H6v5a1 1 0 01-1 1H3a1 1 0 01-1-1v-5H0v-6a2 2 0 012-2h.974zM4 7a2 2 0 11-.001-3.999A2 2 0 014 7z"
                              />
                              <path
                                className={`fill-current ${pathname.includes('/dashboard/admin/users') ? 'text-indigo-300' : 'text-slate-400'}`}
